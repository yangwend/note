	...
	<el-form size="small">
		...
		<el-form-item>
			<el-radio :label="3" v-model='radioValue'>
				周期从
				<el-input-number v-model='cycle01' :min='fullYear' :max="fullYear + 100" /> -
				<el-input-number v-model='cycle02' :min='fullYear + 1' :max="fullYear + 101" />
			</el-radio>
		</el-form-item>
		...
		<el-form-item>
			<el-radio :label="4" v-model='radioValue'>
				从
				<el-input-number v-model='average01' :min='fullYear' :max="fullYear + 100" /> 年开始，每
